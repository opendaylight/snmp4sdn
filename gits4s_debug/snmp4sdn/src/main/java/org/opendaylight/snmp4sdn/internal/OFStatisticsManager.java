...
import org.opendaylight.snmp4sdn.vendorextension.v6extension.V6StatsReply;
import org.opendaylight.snmp4sdn.vendorextension.v6extension.V6StatsRequest;
...
IInventoryShimExternalListener, CommandProvider {
    ...
    void init() {
        ...
        System.out.println("OFStatisticsManager.init() done");
    }
    ...
    private void notifyDescriptionListeners(Long switchId,
        ...
        for (IStatisticsListener l : this.descriptionListeners) {
            l.descriptionRefreshed(switchId,
                    ((SNMPDescriptionStatistics) values.get(0)));
        }
    }

...
@Command(scope = "snmp4sdn", name = "DeleteFlow", description="Add VLAN and set the VLAN ports on the switch")
public class DeleteFlow extends OsgiCommandSupport{
    ...
    protected Object doExecute() throws Exception {
        ...
        flowprogrammer.krfDeleteFlow(sw_mac, vlanIdStr, dstMacStr, portNumStr);
        return null;
    }

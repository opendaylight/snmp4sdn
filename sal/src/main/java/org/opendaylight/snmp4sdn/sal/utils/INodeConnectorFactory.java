...
public interface INodeConnectorFactory {
     ...
     * @param typeStr
     *            {@Link
     *            org.opendaylight.snmp4sdn.sal.core.NodeConnector} type
     *            string
     * @param IDStr
     *            {@Link
     *            org.opendaylight.snmp4sdn.sal.core.NodeConnector} ID string
     * @return the custom {@Link
     *         org.opendaylight.snmp4sdn.sal.core.NodeConnector}
     */

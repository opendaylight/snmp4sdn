...
package org.opendaylight.snmp4sdn.sal.match;
...
import org.opendaylight.snmp4sdn.sal.utils.IPProtocols;
...
public class Match implements Cloneable, Serializable {
     ...
     *
     * @return the 32 bit long mask (Refer to {@code}org.opendaylight.snmp4sdn.sal.match.MatchElement)
     */

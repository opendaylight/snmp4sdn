...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String namespace = "urn:opendaylight:snmp4sdn:md:vlan";
    private final String revision = "2014-08-15";
    private final String resourcePath = "/META-INF/yang/vlan.yang";

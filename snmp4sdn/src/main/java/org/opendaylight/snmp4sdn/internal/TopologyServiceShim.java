...
public class TopologyServiceShim implements IDiscoveryListener,
    ...
    void setTopologyServiceShimListener(/*Map<?, ?> props,*/
        ...
        String containerName = GlobalConstants.DEFAULT.toString();//bug fix (just workaround): eleminate the input parameter, since in Activator there's no parameter pass to here setTopologyServiceShimListener(), so we hardcode the containerName here

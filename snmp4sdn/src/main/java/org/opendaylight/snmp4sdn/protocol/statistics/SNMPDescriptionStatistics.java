...
import org.opendaylight.snmp4sdn.protocol.util.StringByteSerializer;

/**
 * Represents an ofp_desc_stats structure
 * @author David Erickson (daviderickson@cs.stanford.edu)
 */
public class SNMPDescriptionStatistics implements SNMPStatistics, Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof SNMPDescriptionStatistics)) {
            return false;
        }
        SNMPDescriptionStatistics other = (SNMPDescriptionStatistics) obj;

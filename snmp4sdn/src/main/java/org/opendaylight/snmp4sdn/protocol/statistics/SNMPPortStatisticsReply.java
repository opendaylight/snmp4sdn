 ...
 */
public class SNMPPortStatisticsReply implements SNMPStatistics {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof SNMPPortStatisticsReply)) {
            return false;
        }
        SNMPPortStatisticsReply other = (SNMPPortStatisticsReply) obj;

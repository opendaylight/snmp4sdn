package org.opendaylight.yang.gen.v1.urn.opendaylight.snmp4sdn.md.types.rev150126 ;
...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "snmp4sdn-types";
    private final String namespace = "urn:opendaylight:snmp4sdn:md:types";
    private final String revision = "2015-01-26";
    private final String resourcePath = "/META-INF/yang/snmp4sdn-types.yang";
